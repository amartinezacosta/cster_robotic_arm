 ...
 *           from CMSIS SVD File 'TM4C1233H6PM.svd' Version 12591,
 *
 * @par      
...
typedef struct {                                    /*!< USB0 Structure                                                        */
  ...
  __I  uint32_t  RESERVED15[13];
  __IO uint32_t  DMASEL;                            /*!< USB DMA Select                                                        */
  __I  uint32_t  RESERVED16[731];
